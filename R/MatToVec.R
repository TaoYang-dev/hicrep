...
#'
#' The matrix format is the standard input for the HiCRep reproducibility analysis. 
#' It has the dimension of \eqn{N*(3+N)}. The additional first three columns are 
#' chromosome name, and mid-point coordinates of two contacting bins. The converted
#' format has three columns. The first two columns are mid-point coordinates of two
#' contacting bins, and the third column is the reads number in each bin.
#'
#' @param dat a Hi-C intra-chromosome matrix in the format of \eqn{N*N} (No chromsome 
#' name and coordinates columns).
#' @return a vectorized Hi-C data. The first two columns are mid-point coordinates of 

...
#' @param chromsome1 character number which specify chromsome to extract.
#' @param chromsome2 for intra-chromsome data, set it same as chromosome 1; 
#' for inter-chromosome, set to another chromosome.
#' @param resol resolution, i.e., bin size.
#' @method specifies what data to extract, raw or normalized. Must be one of 
#' NONE/VC/VC_SQRT/KR. NONE will gives raw counts. VC is vanilla coverage, 
#' VC_SQRT is square root of vanilla coverage, and KR is Knight-Ruiz or 
